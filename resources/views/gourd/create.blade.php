        ...
        <div class=' col-md-12'>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <form action='{{route('gourd.store')}}' method="post" autocomplete="off">
                        @csrf
                        <div class="box-body">
                        <div class="">
                        ...
                        <div class="col-md-12">
                            <label>Purpose</label>
                            <textarea id="purpose" name="purpose" placeholder='100 words' class='form-control input-sm' ></textarea>
                        </div>
                        </div><!-- /.box-body -->
...
@section('js')
    <script>
        ...
        {
            $.get('{{route('gourd.index')}}/'+mobile,function(resp){
                if(resp.status){
                    var data = resp.data;
                    ...
                    $('#city').val(data.city);
                    $('#stateId').val(data.stateId).change();
